...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[MFM] Microscience HH-1090 (80 MB)",               .internal_name = "HH1090",       .model = "HH 1090",                                                     .zones =  1, .avg_spt =  17, .heads =  7, .rpm = 3600, .full_stroke_ms = 60, .track_seek_ms = 5,   .rcache_num_seg =  1, .rcache_seg_size =   32, .max_multiple =  1 },
    ...
    { .name = "[MFM] Seagate ST-124 (20 MB)",                     .internal_name = "ST124",        .model = "st124",                                                       .zones =  1, .avg_spt =  17, .heads =  4, .rpm = 3600, .full_stroke_ms = 65, .track_seek_ms = 8,   .rcache_num_seg =  1, .rcache_seg_size =   17, .max_multiple =  1 },
    { .name = "[MFM] Seagate ST-225 (20 MB)",                     .internal_name = "ST225",        .model = "st225",                                                       .zones =  1, .avg_spt =  17, .heads =  4, .rpm = 3600, .full_stroke_ms = 65, .track_seek_ms = 8,   .rcache_num_seg =  1, .rcache_seg_size =   17, .max_multiple =  1 },
    { .name = "[MFM] Seagate ST-251 (40 MB)",                     .internal_name = "ST251",        .model = "st251",                                                       .zones =  1, .avg_spt =  17, .heads =  6, .rpm = 3600, .full_stroke_ms = 65, .track_seek_ms = 8,   .rcache_num_seg =  1, .rcache_seg_size =   17, .max_multiple =  1 },
    { .name = "[MFM] Seagate ST-4038 (32 MB)",                    .internal_name = "ST4038",       .model = "st4038",                                                      .zones =  1, .avg_spt =  17, .heads =  5, .rpm = 3600, .full_stroke_ms = 80, .track_seek_ms = 10,  .rcache_num_seg =  1, .rcache_seg_size =   17, .max_multiple =  1 },
    { .name = "[MFM] Seagate ST-4051 (43 MB)",                    .internal_name = "ST4051",       .model = "st4051",                                                      .zones =  1, .avg_spt =  17, .heads =  5, .rpm = 3600, .full_stroke_ms = 80, .track_seek_ms = 10,  .rcache_num_seg =  1, .rcache_seg_size =   17, .max_multiple =  1 },
    { .name = "[MFM] Seagate ST-4096 (80 MB)",                    .internal_name = "ST4096",       .model = "st4096",                                                      .zones =  1, .avg_spt =  17, .heads =  9, .rpm = 3600, .full_stroke_ms = 80, .track_seek_ms = 6,   .rcache_num_seg =  1, .rcache_seg_size =   17, .max_multiple =  1 },
    ...
    { .name = "[RLL] Microscience HH-1120 (122 MB)",              .internal_name = "HH1120",       .model = "HH 1120",                                                     .zones =  1, .avg_spt =  26, .heads =  7, .rpm = 3600, .full_stroke_ms = 60, .track_seek_ms = 5,   .rcache_num_seg =  1, .rcache_seg_size =   26, .max_multiple =  1 },
    ...
    { .name = "[PIO IDE] Western Digital WD93024-A",              .internal_name = "WD93024A",     .model = "WD93024A",                                                    .zones =  1, .avg_spt =  33, .heads =  1, .rpm = 3600, .full_stroke_ms = 33, .track_seek_ms = 4,   .rcache_num_seg =  1, .rcache_seg_size =   32, .max_multiple =  1 },
    { .name = "[PIO IDE] Western Digital WD93044-A",              .internal_name = "WD93044A",     .model = "WD93044A",                                                    .zones =  1, .avg_spt =  50, .heads =  1, .rpm = 3600, .full_stroke_ms = 33, .track_seek_ms = 4,   .rcache_num_seg =  1, .rcache_seg_size =   32, .max_multiple =  1 },
