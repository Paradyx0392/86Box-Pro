...
#ifdef EMU_DEVICE_H
extern const device_t  dtk486_device;
#endif
extern int             machine_at_dtk486_init(const machine_t *);
#ifdef EMU_DEVICE_H
extern const device_t  ami471_device;
#endif
...
#ifdef EMU_DEVICE_H
extern const device_t  zi4d_device;
#endif
extern int             machine_at_zi4d_init(const machine_t *);
...
#ifdef EMU_DEVICE_H
extern const device_t  robinlc_device;
#endif
...
#ifdef EMU_DEVICE_H
extern const device_t  bmb8500_device;
#endif
extern int             machine_at_bmb8500_init(const machine_t *);
#ifdef EMU_DEVICE_H
...
extern int             machine_at_pam0056i_init(const machine_t *);
extern int             machine_at_pam0070i_init(const machine_t *);
#ifdef EMU_DEVICE_H
...
/* VIA VP3 */
#ifdef EMU_DEVICE_H
extern const device_t  ficpa2012_device;
#endif
...
extern int             machine_at_686fx_init(const machine_t *);
...
#endif
extern int             machine_at_epox61lxam_init(const machine_t *);
#ifdef EMU_DEVICE_H
...
#ifdef EMU_DEVICE_H
extern const device_t  bx6v20_device;
#endif
extern int             machine_at_bx6v20_init(const machine_t *);
#ifdef EMU_DEVICE_H
extern const device_t  ax6b_device;
#endif
extern int             machine_at_ax6b_init(const machine_t *);
#ifdef EMU_DEVICE_H
extern const device_t  ax6bc_device;
#endif
extern int             machine_at_ax6bc_init(const machine_t *);
#ifdef EMU_DEVICE_H
extern const device_t  ax6bcpro_device;
#endif
extern int             machine_at_ax6bcpro_init(const machine_t *);
#ifdef EMU_DEVICE_H
...
#ifdef EMU_DEVICE_H
extern const device_t  cb650mbx_device;
#endif
...
#ifdef EMU_DEVICE_H
extern const device_t  g6a_device;
#endif
extern int             machine_at_g6a_init(const machine_t *);
extern int             machine_at_ga6bxa_init(const machine_t *);
#ifdef EMU_DEVICE_H
extern const device_t  ga6bxc_device;
#endif
extern int             machine_at_ga6bxc_init(const machine_t *);
extern int             machine_at_bxmaster_init(const machine_t *);
#ifdef EMU_DEVICE_H
...
#ifdef EMU_DEVICE_H
extern const device_t  ms6147v11_device;
#endif
...
#endif
extern int             machine_at_in440zx_init(const machine_t *);
#ifdef EMU_DEVICE_H
extern const device_t  med9901_device;
#endif
extern int             machine_at_med9901_init(const machine_t *);
#ifdef EMU_DEVICE_H
extern const device_t  vei8_device;
#endif
extern int             machine_at_vei8_init(const machine_t *);
extern int             machine_at_ms6147zx_init(const machine_t *);
#ifdef EMU_DEVICE_H
...
/* VIA Apollo Pro 133 */
#ifdef EMU_DEVICE_H
extern const device_t  m6vca_device;
#endif
...
/* i440BX */
#ifdef EMU_DEVICE_H
extern const device_t  bm6_device;
#endif
...
#ifdef EMU_DEVICE_H
extern const device_t  p6bap_device;
#endif
extern int             machine_at_p6bap_init(const machine_t *);
extern int             machine_at_p6bapme_init(const machine_t *);
#ifdef EMU_DEVICE_H
extern const device_t  p6vaa_device;
#endif
...
/* VIA Apollo Pro 133A */
extern int             machine_at_awin694x_init(const machine_t *);
extern int             machine_at_6via90ap_init(const machine_t *);
#ifdef EMU_DEVICE_H
extern const device_t  cuv4xcm_device;
#endif
extern int             machine_at_cuv4xcm_init(const machine_t *);
#ifdef EMU_DEVICE_H
...
#ifdef EMU_DEVICE_H
extern const device_t  mb694a_device;
#endif
...
#ifdef EMU_DEVICE_H
extern const device_t  ls694xpro_device;
#endif
extern int             machine_at_ls694xpro_init(const machine_t *);
#ifdef EMU_DEVICE_H
