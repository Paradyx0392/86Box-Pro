...
static const device_config_t p5a_config[] = {
    // clang-format off
    {
        ...
        .bios           = {
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1003",
                .internal_name = "p5a_1003",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/p5a/AL5I1003.AWD", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1004",
                .internal_name = "p5a_1004",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/p5a/AL5I1004.AWD", "" }
            },
            {
...
static const device_config_t m5ala_config[] = {
    // clang-format off
    {
        ...
        .bios           = {
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 11/05/1999",
                .internal_name = "m5ala_1999",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/m5ala/ALA1105B.BIN", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 11/22/2000",
                .internal_name = "m5ala",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/m5ala/ALA1122B.BIN", "" }
            },
            { .files_no = 0 }
        }
    },
...
int
machine_at_m5ala_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
...
static const device_config_t m579_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        ...
        .bios           = {
            {
                .name          = "AMIBIOS 6 (071595) - Release 01/07/1999 S",
                .internal_name = "m579",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/m579/0107s.rom", "" }
            },
            {
                .name          = "AMIBIOS 6 (071595) - Release 10/26/1999 S (Matsonic MS-6260S)",
                .internal_name = "ms6260s",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/m579/MS6260S_Socket7_ALi_M1542_AMI.BIN", "" }
            },
            { .files_no = 0 }
        }
    },
...
static const device_config_t g5a_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        ...
        .bios           = {
            ...
            },
            {
                ...
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/5aa/GA-5AA.F7b", "" }
            },
            { .files_no = 0 }
        }
    },
...
const device_t g5a_device = {
    .name          = "Gigabyte GA-5AA",
    .internal_name = "5aa",
    .flags         = 0,
    .local         = 0,
    .init          = NULL,
...
int
machine_at_g5a_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
    ...
    // clang-format off
    {
        ...
        .bios           = {
            ...
            },
            {
                ...
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/ms5169/a569ms38.003", "" }
            },
            { .files_no = 0 }
        }
    },
...
/* VIA MVP3 */
int
machine_at_5via77_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/5via77/via77a7.BIN",
                           0x000e0000, 131072, 0);
...
static const device_config_t ax59pro_config[] = {
    // clang-format off
    {
        ...
        .bios           = {
            {
                .name          = "Award Modular BIOS v4.60PGMA - Revision 2.35",
                .internal_name = "ax59pro_235",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ax59pro/AX59P235.BIN", "" }
            },
            {
                .name          = "Award Modular BIOS v4.60PGMA - Revision 2.36",
...
static const device_config_t sl54u5_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "sl54u5",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                .name          = "Award Modular BIOS v4.51PG - Revision A10",
                .internal_name = "sl54u5_a10",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
            ...
            },
            {
                ...
                .internal_name = "sl54u5",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/sl54u5/54U5-A11-1.BIN", "" }
            },
            { .files_no = 0 }
        }
    },
...
const device_t sl54u5_device = {
    ...
    .speed_changed = NULL,
    .force_redraw  = NULL,
    .config        = sl54u5_config
};

int
machine_at_sl54u5_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
...
static const device_config_t sl56d5_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "sl56d5",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                .name          = "Award Modular BIOS v4.51PG - Revision L5",
                .internal_name = "sl56d5",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/sl56d5/56d-l5.bin", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision L5.2 (Magic-Pro MP-VIP4-X)",
                .internal_name = "mpvip4x",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/sl56d5/v4xl52.bin", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - 2001 Revision (beta)",
                .internal_name = "sl56d5beta",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/sl56d5/56d5.bin", "" }
            },
            { .files_no = 0 }
        }
    },
...
const device_t sl56d5_device = {
    ...
    .speed_changed = NULL,
    .force_redraw  = NULL,
    .config        = sl56d5_config
};

int
machine_at_sl56d5_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
...
int
machine_at_sl56h5_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/sl56h5/56h-m1.bin",
                           0x000e0000, 131072, 0);
