...
/* VIA Apollo Pro 133A */
int
machine_at_694xa_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/694xa/694xav10.bin",
                           0x000c0000, 262144, 0);
...
int
machine_at_694xt_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/694xt/694xtv10.bin",
                           0x000c0000, 262144, 0);
