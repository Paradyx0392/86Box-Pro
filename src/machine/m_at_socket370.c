    ...
    // clang-format off
    {
        ...
        .bios           = {
            ...
            },
            {
                ...
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/m6vci/vci0517b.bin", "" }
            },
            { .files_no = 0 }
        }
    },
...
static const device_config_t m6vci_config[] = {
    // clang-format off
    {
        ...
        .bios           = {
            {
                .name          = "Award Modular BIOS v6.00PG - Revision 01/11/2001",
            ...
            {
                .name          = "Award Modular BIOS v6.00PG - Revision 05/21/2001",
                .internal_name = "m6vci",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
...
machine_at_j694as_init(const machine_t *model)
{
    ...
    ret = bios_load_linear("roms/machines/j694as/694ASA15.BIN",
                           0x000c0000, 262144, 0);
...
machine_at_j694cs_init(const machine_t *model)
{
    ...
    ret = bios_load_linear("roms/machines/j694cs/694CSA11.BIN",
                           0x000c0000, 262144, 0);
