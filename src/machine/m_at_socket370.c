...
/* VIA Apollo Pro 133A */
int
machine_at_awin694x_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/awin694x/694x11E.BIN",
                           0x000c0000, 262144, 0);
...
static const device_config_t gt694vp_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "gt694vp",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                ...
                .internal_name = "gt694vp_100",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/gt694vp/21211100.bin", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1.01",
                .internal_name = "gt694vp_101",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/gt694vp/21211101.bin", "" }
            },
            {
                ...
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/gt694vp/21211102.bin", "" }
            },
            { .files_no = 0 }
        }
    },
...
int
machine_at_p6f117_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/p6f117/117-4.BIN",
                           0x000c0000, 262144, 0);
    ...
    pci_register_slot(0x0D, PCI_CARD_NORMAL,      4, 1, 2, 3);
    pci_register_slot(0x0C, PCI_CARD_NORMAL,      1, 2, 3, 4);
    pci_register_slot(0x0B, PCI_CARD_SOUND,       1, 2, 3, 4);
    pci_register_slot(0x01, PCI_CARD_AGPBRIDGE,   1, 2, 3, 4);
...
int
machine_at_pt694xa_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/pt694xa/694X-A.bin",
                           0x000c0000, 262144, 0);
