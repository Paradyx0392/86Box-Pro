...
static const device_config_t kn97_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        ...
        .bios           = {
            ...
            },
            {
                ...
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/kn97/0116I.001", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 0116i",
                .internal_name = "kn97",
                .bios_type     = BIOS_NORMAL, 
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/kn97/NAKI0116.AWD", "" }
            },
            { .files_no = 0 }
        },
    },
    ...
    // clang-format off
    {
        ...
        .bios           = {
            ...
            },
            {
                ...
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/lx6/LX6C_7Q.bin", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 7T",
                .internal_name = "lx6_7t",
                .bios_type     = BIOS_NORMAL, 
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
            ...
            {
                .name          = "Award Modular BIOS v4.51PG - Revision DR",
                .internal_name = "lx6_dr",
                .bios_type     = BIOS_NORMAL, 
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/lx6/LX6C_DR.bin", "" }
            },
            {
...
int
machine_at_p6lxi_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/p6lxi/p6lxi26y.bin",
                           0x000c0000, 262144, 0);
...
static const device_config_t ax6l_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        ...
        .bios           = {
            {
                ...
                .internal_name = "ax6l_110",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ax6l/ax6l110.bin", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PGM - Revision R1.20",
                .internal_name = "ax6l_120",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ax6l/ax6l120.bin", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PGM - Revision R1.30",
                .internal_name = "ax6l_130",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ax6l/ax6l130.bin", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PGM - Revision R1.40",
                .internal_name = "ax6l_140",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ax6l/ax6l140.bin", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PGM - Revision R1.50",
                .internal_name = "ax6l",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ax6l/ax6l150.bin", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PGM - Revision R1.51d",
                .internal_name = "ax6l_beta",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ax6l/ax6l151d.bin", "" }
            },
            { .files_no = 0 }
        }
    },
...
int
machine_at_ax6l_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
...
static const device_config_t ax6lc_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "ax6lc",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            ...
            },
            {
                ...
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ax6lc/ax6lc120.bin", "" }
            },
            {
...
int
machine_at_ax6lc_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
...
int
machine_at_ax6lclite_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/ax6lclite/6lclt110.bin",
                           0x000c0000, 262144, 0);
...
static const device_config_t prm0076i_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "prm0076i",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1.07",
                .internal_name = "prm0076i",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/prm0076i/76I107.BIN", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 3.15",
                .internal_name = "prm0076i_315",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/prm0076i/prm76v315.bin", "" }
            },
            { .files_no = 0 }
        }
    },
...
const device_t prm0076i_device = {
    .name          = "DTK PRM-0076i",
    .internal_name = "prm0076i",
    .flags         = 0,
    .local         = 0,
    ...
    .speed_changed = NULL,
    .force_redraw  = NULL,
    .config        = prm0076i_config
};

int
machine_at_prm0076i_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
    ...
    if (!strcmp(fn, "roms/machines/prm0076i/76I107.BIN"))
...
static const device_config_t epox61lxam_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "epox61lxam",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 12/03/1998 (NMC 6LDX-B)",
                .internal_name = "nmc6ldxb",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
...
const device_t epox61lxam_device = {
    .name          = "Epox 61LXA-M",
    .internal_name = "epox61lxam",
    .flags         = 0,
    .local         = 0,
    ...
    .speed_changed = NULL,
    .force_redraw  = NULL,
    .config        = epox61lxam_config
};

int
machine_at_epox61lxam_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
...
int
machine_at_sl61b_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/sl61b/61b-e3.bin",
                           0x000e0000, 131072, 0);
...
int
machine_at_sl66f_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/sl66f/66f-c5.bin",
                           0x000e0000, 131072, 0);
...
/* i440EX */
static const device_config_t mx6ep_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        ...
        .bios           = {
            {
              .name          = "Award Modular BIOS v4.51PGM - Revision R1.10",
              .internal_name = "mx6ep_451pg110",
              .bios_type     = BIOS_NORMAL, 
              .files_no      = 1,
              .local         = 0,
              .size          = 262144,
              .files         = { "roms/machines/mx6ep/mx6ep110.bin", "" }
            },
            {
              .name          = "Award Modular BIOS v4.51PGM - Revision R1.20",
              .internal_name = "mx6ep_451pg",
              .bios_type     = BIOS_NORMAL, 
              .files_no      = 1,
              .local         = 0,
              .size          = 262144,
              .files         = { "roms/machines/mx6ep/mx6ep120.bin", "" }
            },
            {
              .name          = "Award Modular BIOS v4.60PGMA - Revision R2.10",
              .internal_name = "mx6ep",
              .bios_type     = BIOS_NORMAL, 
              .files_no      = 1,
              .local         = 0,
              .size          = 262144,
              .files         = { "roms/machines/mx6ep/mx6ep210.bin", "" }
            },
            { .files_no = 0 }
        },
    },
...
int
machine_at_mx6ep_init(const machine_t *model)
{
    int ret = 0;
    const char* fn;
...
static const device_config_t in440ex_config[] = {
    // clang-format off
    {
        ...
        .bios           = {
            ...
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1.00 (Toshiba Equium 3000M)",
            ...
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1.01 (Toshiba Equium 3000M)",
            ...
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1.02 (Gobi Internet PC)",
            ...
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1.03",
    ...
    // clang-format off
    {
        ...
        .bios           = {
            ...
            },
            {
                ...
                .internal_name = "bx6_HV",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/bx6/BX6_HV.bin", "" }
            },
            {
...
static const device_config_t p2bls_config[] = {
    // clang-format off
    {
        ...
        .bios           = {
            ...
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1010",
                .internal_name = "p2bls_1010",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/p2bls/BXLS1010.AWD", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1011",
            ...
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1014 Beta 003",
                .internal_name = "p2bls_1014beta003",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
    ...
    // clang-format off
    {
        ...
        .bios           = {
            ...
            },
            {
                ...
                .internal_name = "p3bf_1008beta004",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
...
static const device_config_t ax6b_config[] = {
    // clang-format off
    {
        ...
        .bios           = {
            ...
            {
                .name          = "Award Modular BIOS v4.60PGMA - Revision R2.10",
                .internal_name = "ax6b_210",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ax6b/ax6b210.bin", "" }
            },
            {
                .name          = "Award Modular BIOS v4.60PGMA - Revision R2.31",
                .internal_name = "ax6b_231",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ax6b/ax6b231.bin", "" }
            },
            {
                .name          = "Award Modular BIOS v4.60PGMA - Revision R2.32",
                .internal_name = "ax6b_232",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ax6b/ax6b232.bin", "" }
            },
            {
    ...
    // clang-format off
    {
        ...
        .bios           = {
            ...
            },
            {
                ...
                .internal_name = "ax6bc_258",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ax6bc/ax6bc258.bin", "" }
            },
            {
    ...
    // clang-format off
    {
        ...
        .bios           = {
            ...
            },
            {
                ...
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ax6bcproii/6bcp2115.BIN", "" }
            },
            {
                .name          = "Award Modular BIOS v4.60PGMA - Revision R1.15j (Japanese)",
                .internal_name = "ax6bcproii_115j",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ax6bcproii/bcp2115j.BIN", "" }
            },
            {
                .name          = "Award Modular BIOS v4.60PGMA - Revision R1.16",
                .internal_name = "ax6bcproii_116",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ax6bcproii/6bcp2116.BIN", "" }
            },
            {
                .name          = "Award Modular BIOS v4.60PGMA - Revision R1.18",
                .internal_name = "ax6bcproii_118",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ax6bcproii/6BCP2118.BIN", "" }
            },
            {
                .name          = "Award Modular BIOS v4.60PGMA - Revision R1.19",
                .internal_name = "ax6bcproii",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ax6bcproii/6bcp2119.bin", "" }
            },
            { .files_no = 0 }
        }
    },
...
const device_t ax6bcproii_device = {
    .name          = "AOpen AX6BC Pro II",
    .internal_name = "ax6bcproii",
    .flags         = 0,
    .local         = 0,
    .init          = NULL,
    ...
    .speed_changed = NULL,
    .force_redraw  = NULL,
    .config        = ax6bcproii_config
};

int
machine_at_ax6bcproii_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
    ...
    // clang-format off
    {
        ...
        .bios           = {
            ...
            },
            {
              ...
              .local         = 0,
              .size          = 262144,
              .files         = { "roms/machines/m003/M003NL47.bin", "" }
            },
            { .files_no = 0 }
        },
    },
...
int
machine_at_mbx8440_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/mbx8440/MBX8440C.BIN",
                           0x000e0000, 131072, 0);
...
static const device_config_t p2xbl_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        ...
        .bios           = {
            {
              .name          = "Award Modular BIOS v4.51PG - Revision 10/26/1999",
              .internal_name = "p2xbl",
              .bios_type     = BIOS_NORMAL, 
              .files_no      = 1,
              .local         = 0,
            ...
            {
              .name          = "Phoenix-AwardBIOS v6.00PG - Release 4.3 (by eSupport)",
              .internal_name = "p2xbl_esupport",
              .bios_type     = BIOS_NORMAL, 
              .files_no      = 1,
              .local         = 0,
              .size          = 262144,
              .files         = { "roms/machines/p2xbl/6Z69KD49.BIN", "" }
            },
            { .files_no = 0 }
        },
    },
...
const device_t p2xbl_device = {
    .name          = "DFI P2XBL (rev. AB+)",
    .internal_name = "p2xbl",
    .flags         = 0,
    .local         = 0,
    .init          = NULL,
...
int
machine_at_p2xbl_init(const machine_t *model)
{
    int         ret = 0;
    const char* fn;
...
static const device_config_t prm0080i_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "prm0080i",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 2.06",
                .internal_name = "prm0080i",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/prm0080i/prm80v206.bin", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 3.08",
                .internal_name = "prm0080i_308",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/prm0080i/prm80v308.bin", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 3.18",
                .internal_name = "prm0080i_318",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/prm0080i/prm80v318.bin", "" }
            },
            { .files_no = 0 }
        }
    },
...
const device_t prm0080i_device = {
    .name          = "DTK PRM-0080i",
    .internal_name = "prm0080i",
    .flags         = 0,
    .local         = 0,
    ...
    .speed_changed = NULL,
    .force_redraw  = NULL,
    .config        = prm0080i_config
};

int
machine_at_prm0080i_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
    ...
    if (!strcmp(fn, "roms/machines/prm0080i/prm80v206.bin"))
        device_add_params(&fdc37c67x_device, (void *) (FDC37XXX2 | FDC37XXXX_370));
    else
        device_add_params(&w83977_device, (void *) (W83977EF | W83977_AMI | W83977_NO_NVR));
...
int
machine_at_epoxbx3_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/epoxbx3/bxc00920.bin",
                           0x000c0000, 262144, 0);
...
static const device_config_t p6f91i_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "p6f91i",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 7 (Decision Technology OEM)",
                .internal_name = "p6f91i_dt",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/p6f91i/96d-7m2.bin", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 11",
                .internal_name = "p6f91i",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/p6f91i/96-11m2.bin", "" }
            },
            { .files_no = 0 }
        }
    },
...
const device_t p6f91i_device = {
    .name          = "Freetech/Flexus P6F91i",
    .internal_name = "p6f91i",
    .flags         = 0,
    .local         = 0,
    .init          = NULL,
    ...
    .speed_changed = NULL,
    .force_redraw  = NULL,
    .config        = p6f91i_config
};

int
machine_at_p6f91i_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
...
static const device_config_t ga686_config[] = {
    // clang-format off
    {
        ...
        .bios           = {
            ...
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 2/10/1999 (Amptron PII-3100A)",
                .internal_name = "pii3100a",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/686bx/31AP3.BIN", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1.12",
                .internal_name = "686bx_112",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/686bx/6bx.112", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1.15",
                .internal_name = "686bx_115",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/686bx/6bx.115", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 2.11",
                .internal_name = "686bx_211",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/686bx/6bx.211", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 2.2",
                .internal_name = "686bx_22",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/686bx/6BX.22", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 2.7",
                .internal_name = "686bx_27",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/686bx/6bx.27", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 2.8",
                .internal_name = "686bx_28",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/686bx/6bx.28", "" }
            },
            {
...
static const device_config_t g6a_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        ...
        .bios           = {
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1.03",
                .internal_name = "6ba_103",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/6ba/6ba.103", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1.06",
                .internal_name = "6ba_106",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/6ba/6ba.106", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 2.02",
                .internal_name = "6ba_202",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/6ba/6ba.202", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 2.1",
                .internal_name = "6ba_21",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/6ba/6BA.21", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 2.4",
                .internal_name = "6ba_24",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/6ba/6BA.24", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 2.5",
                .internal_name = "6ba_25",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/6ba/6ba.25", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 2.6",
                .internal_name = "6ba_26",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/6ba/6BA.26", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 2.7",
                .internal_name = "6ba_27",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/6ba/6BA.27", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 2.8",
                .internal_name = "6ba_28",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/6ba/6BA.28", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 2.9",
                .internal_name = "6ba_29",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/6ba/6ba.29", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision F1g",
                .internal_name = "6ba_f1g",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/6ba/6BA.F1g", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision F1",
                .internal_name = "6ba",
                ...
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/6ba/6BA.F1", "" }
            },
            { .files_no = 0 }
        }
    },
...
const device_t g6a_device = {
    .name          = "Gigabyte GA-6BA",
    .internal_name = "6ba",
    .flags         = 0,
    .local         = 0,
    .init          = NULL,
...
int
machine_at_g6a_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
...
int
machine_at_ga6bxa_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/ga6bxa/6BXA.12",
                           0x000c0000, 262144, 0);
    ...
    pci_register_slot(0x0A, PCI_CARD_NORMAL,      3, 4, 1, 2);
    pci_register_slot(0x0B, PCI_CARD_NORMAL,      4, 1, 2, 3);
    pci_register_slot(0x0C, PCI_CARD_NORMAL,      1, 2, 3, 4); /* sound assumed */
    pci_register_slot(0x0D, PCI_CARD_NORMAL,      2, 3, 4, 1);
    pci_register_slot(0x01, PCI_CARD_AGPBRIDGE,   1, 2, 3, 4);
...
static const device_config_t ga6bxc_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "ga6bxc",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                ...
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ga6bxc/6BXC.F3", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision F4c (Beta)",
                .internal_name = "ga6bxc",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ga6bxc/6BXC.F4c", "" }
            },
            { .files_no = 0 }
        }
    },
...
const device_t ga6bxc_device = {
    .name          = "Gigabyte GA-6BXC",
    .internal_name = "ga6bxc",
    .flags         = 0,
    .local         = 0,
    .init          = NULL,
    ...
    .speed_changed = NULL,
    .force_redraw  = NULL,
    .config        = ga6bxc_config
};

int
machine_at_ga6bxc_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
...
static const device_config_t ms6147_config[] = {
    // clang-format off
    {
        ...
        .bios           = {
            ...
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1.6",
                .internal_name = "ms6147_16",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ms6147/W647MS16.BIN", "" }
            },
            {
...
int
machine_at_ms6156_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/ms6156/W6156IMS.160",
                           0x000c0000, 262144, 0);
...
machine_at_ms6163_init(const machine_t *model)
{
    ...
    ret = bios_load_linear("roms/machines/ms6163/W6163IMJ.270",
                           0x000c0000, 262144, 0);
...
int
machine_at_bxmaster_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/bxmaster/w6163imj.560",
                           0x000c0000, 262144, 0);
...
int
machine_at_ms6199_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/ms6199/W699MJ33.BIN",
                           0x000c0000, 262144, 0);
...
static const device_config_t hot661p_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "hot661p",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                .name          = "Award Modular BIOS v4.51PG - Revision S164",
                .internal_name = "hot661p",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/hot661p/6610S164.bin", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Release 4.2 (by eSupport)",
                .internal_name = "hot661p_esupport",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/hot661p/2a69kh2b.bin", "" }
            },
            { .files_no = 0 }
        }
    },
...
const device_t hot661p_device = {
    .name          = "Shuttle HOT-661/P",
    .internal_name = "hot661p",
    .flags         = 0,
    .local         = 0,
    .init          = NULL,
    ...
    .speed_changed = NULL,
    .force_redraw  = NULL,
    .config        = hot661p_config
};

int
machine_at_hot661p_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
...
int
machine_at_sl62a_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/sl62a/62a-j.bin",
                           0x000e0000, 131072, 0);
...
int
machine_at_sl62b_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/sl62b/62bc-m4.bin",
                           0x000c0000, 262144, 0);
...
int
machine_at_sl67a_init(const machine_t *model)
{
    int ret;
...
int
machine_at_67eb_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/67eb/67ezb-r8.bin",
                           0x000c0000, 262144, 0);
...
/* i440ZX */
static const device_config_t mx6bez_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "mx6bez",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                .name          = "Award Modular BIOS v4.60PGMA - Revision R1.02",
                .internal_name = "mx6bez_102",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/mx6bez/6bez102.bin", "" }
            },
            {
                .name          = "Award Modular BIOS v4.60PGMA - Revision R1.03",
                .internal_name = "mx6bez_103",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/mx6bez/6bez103.bin", "" }
            },
            {
                .name          = "Award Modular BIOS v4.60PGMA - Revision R1.04",
                .internal_name = "mx6bez_104",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/mx6bez/6bez104.bin", "" }
            },
            {
                .name          = "Award Modular BIOS v4.60PGMA - Revision R1.07",
                .internal_name = "mx6bez",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/mx6bez/6bez107.bin", "" }
            },
            { .files_no = 0 }
        }
    },
...
const device_t mx6bez_device = {
    ...
    .speed_changed = NULL,
    .force_redraw  = NULL,
    .config        = mx6bez_config
};

int
machine_at_mx6bez_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
...
static const device_config_t med9901_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "med9901",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1.8",
                .internal_name = "med9901_18",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/med9901/w6190zm7.180", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1.8B4",
                .internal_name = "med9901",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/med9901/w6190zm7.184", "" }
            },
            { .files_no = 0 }
        }
    },
...
const device_t med9901_device = {
    .name          = "Medion MED 9901",
    .internal_name = "med9901",
    .flags         = 0,
    .local         = 0,
    .init          = NULL,
...
static const device_config_t ms6156zx_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "ms6156zx",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                ...
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ms6156zx/V13.BIN", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1.6",
                ...
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ms6156zx/W6156ZMS.160", "" }
            },
            { .files_no = 0 }
        }
    },
...
const device_t ms6156zx_device = {
    .name          = "MSI MS-6156ZX",
    .internal_name = "ms6156zx",
    .flags         = 0,
    .local         = 0,
    ...
    .speed_changed = NULL,
    .force_redraw  = NULL,
    .config        = ms6156zx_config
};

int
machine_at_ms6156zx_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
...
/* NOTE: On Revision 1.3, it has a Legend (now Lenovo) logo at bootup when Full Screen Logo Show is set to On. */
        ...
        .bios           = {
            {
                ...
                .internal_name = "ms6168v12",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ms6168/W668MS12.BIN", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1.3",
...
int
machine_at_sl67d_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/sl67d/67d-p.bin",
                           0x000c0000, 262144, 0);
    ...
    // clang-format off
    {
        ...
        .bios           = {
            ...
            },
            {
                ...
                .internal_name = "p3v133_1003beta002",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
...
int
machine_at_gt693va_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/gt693va/21051104.bin",
                           0x000c0000, 262144, 0);
...
static const device_config_t ms6156va_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "ms6156va",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 2.3 (Fujitsu-Siemens OEM)",
                .internal_name = "ms6156va_230",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ms6156va/56vaf123.bin", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 2.5",
                .internal_name = "ms6156va",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ms6156va/w6156vms.250", "" }
            },
            { .files_no = 0 }
        }
    },
...
const device_t ms6156va_device = {
    .name          = "MSI MS-6156VA",
    .internal_name = "ms6156va",
    .flags         = 0,
    .local         = 0,
    ...
    .speed_changed = NULL,
    .force_redraw  = NULL,
    .config        = ms6156va_config
};

int
machine_at_ms6156va_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
...
int
machine_at_sl67ev1_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/sl67ev1/67ev-v7.bin",
                           0x000c0000, 262144, 0);
    ...
    // clang-format off
    {
        ...
        .bios           = {
            ...
            },
            {
                ...
                .internal_name = "p3v4x_1006beta004",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
...
int
machine_at_sl67jv_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/sl67jv/67jv-k2.bin",
                           0x000c0000, 262144, 0);
...
int
machine_at_r658_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/r658/r658003.bin",
                           0x000c0000, 262144, 0);
