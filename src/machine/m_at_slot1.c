...
static const device_config_t hot661_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "hot661",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                ...
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/hot661/6610S164.bin", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Release 4.2 (by eSupport)",
                .internal_name = "hot661_esupport",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/hot661/2a69kh2b.bin", "" }
            },
            { .files_no = 0 }
        }
    },
