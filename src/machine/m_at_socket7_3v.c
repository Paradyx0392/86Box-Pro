...
static const device_config_t exp8551_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "exp8551",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                .name          = "AMI WinBIOS (101094) - Revision 2.0",
                .internal_name = "exp8551",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/exp8551/AMI20.BIO", "" }
            },
            {
...
const device_t exp8551_device = {
    .name          = "DataExpert EXP8551",
    .internal_name = "exp8551",
    .flags         = 0,
    .local         = 0,
    .init          = NULL,
...
static const device_config_t atlantis_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "atlantis",
        .default_int    = 0,
        .file_filter    = "",
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                .name          = "Intel AMIBIOS - Revision 1.00.07.CL0",
                .internal_name = "atlantis",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 2,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/atlantis/1007cl0_.bio", "roms/machines/atlantis/1007cl0_.bi1", "" }
            },
            {
                .name          = "MR BIOS V3.30",
                .internal_name = "mratlantis",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/atlantis/mr_atlan.bio", "" }
            },
            { .files_no = 0 }
        }
    },
...
machine_at_atlantis_init(const machine_t *model)
{
    ...
    device_context(model->device);
    int is_mr     = !strcmp(device_get_config_bios("bios"), "mratlantis");
    int has_video = !strcmp(device_get_config_bios("bios"), "atlantis");
    fn            = device_get_bios_file(machine_get_device(machine), device_get_config_bios("bios"), 0);
    if (is_mr)
        ret = bios_load_linear(fn, 0x000e0000, 131072, 0);
    else {
...
static const device_config_t ap53_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        ...
        .bios           = {
            {
                .name          = "AMIBIOS 6 (071595) - Revision R2.C0",
                .internal_name = "ap53",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/ap53/ap53r2c0.rom", "" }
            },
            {
                .name          = "AMIBIOS 6 (071595) - Revision R3.C0",
                .internal_name = "ap53_r3c0",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/ap53/ap53r3c0.rom", "" }
            },
            { .files_no = 0 }
        }
    },
...
int
machine_at_p54sps2_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/p54sps2/35s203.bin",
                           0x000e0000, 131072, 0);
