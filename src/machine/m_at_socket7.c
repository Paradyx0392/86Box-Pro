...
int
machine_at_p5txbpro_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/p5txbpro/BPRO22.BIN",
                           0x000e0000, 131072, 0);
...
int
machine_at_p55tx2_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/p55tx2/TX051298.BIN",
                           0x000e0000, 131072, 0);
