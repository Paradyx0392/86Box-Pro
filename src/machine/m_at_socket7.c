...
int
machine_at_hx97_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/hx97/HX5I0205.AWD",
                           0x000e0000, 131072, 0);
    ...
    pci_register_slot(0x0E, PCI_CARD_NORMAL,      1, 2, 3, 4); /* unused? */
    pci_register_slot(0x07, PCI_CARD_SOUTHBRIDGE, 0, 0, 0, 0);
...
static const device_config_t vx97_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        ...
        .bios           = {
            {
                ...
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/vx97/TV5V0204.AWD", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 0204 (Patched)",
                .internal_name = "vx97_patch",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/vx97/0204V_J2.BIN", "" }
            },
            {
                .name          = "MR BIOS 3.46 - Revision V09AB5WL",
                .internal_name = "vx97_mrbios",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/vx97/V09AB5WL.BIO", "" }
            },
            { .files_no = 0 }
        }
    },
...
int
machine_at_vx97_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
