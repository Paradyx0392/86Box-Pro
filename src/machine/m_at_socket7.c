...
int
machine_at_mb8500tax_init(const machine_t *model)
{
    int ret;
...
int
machine_at_hot559_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/hot559/559WUQ0C.BIN",
                           0x000e0000, 131072, 0);
    ...
    // clang-format off
    {
        ...
        .bios           = {
            ...
            },
            {
                ...
                .internal_name = "tx5_DZ",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/tx5/TX5B_DZ.BIN", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision GN",
                .internal_name = "tx5",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/tx5/TX5B_GN.BIN", "" }
            },
            { .files_no = 0 }
        }
    },
...
static const device_config_t ax5tc_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "ax5tc",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                ...
                .internal_name = "ax5tc_110",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ax5tc/ax5tc110.bin", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision R1.20",
                .internal_name = "ax5tc",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ax5tc/ax5tc120.bin", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision R1.30b",
                .internal_name = "ax5tc_130b",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/ax5tc/ax5tc130b.bin", "" }
            },
            { .files_no = 0 }
        }
    },
...
int
machine_at_ax5tc_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
...
static const device_config_t tx97x_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "tx97x",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 0108x",
                .internal_name = "tx97x",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/tx97x/TX5X0108.AWD", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 0112x-1 (beta)",
                .internal_name = "tx97x_beta",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/tx97x/0112X.001", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 0112x-1 (beta and patch)",
                .internal_name = "tx97x_betap",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/tx97x/0112X_J3.BIN", "" }
            },
            { .files_no = 0 }
        }
    },
...
int
machine_at_tx97x_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
    ...
    /* The PCB has an unpopulated footprint for a CT2508 (Vibra 16CL). Although,
       unusually, none of the known production instances have it populated, and
       the manual does not make a mention of it at all. Perhaps it was intended
       for an OEM or a planned but later scrapped variant?
...
static const device_config_t txp4_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        ...
        .bios           = {
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 0109l",
                .internal_name = "txp4_0109",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/txp4/XL5I0109.AWD", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 0112l-1",
                .internal_name = "txp4_0112b",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/txp4/0112L.001", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 0112l-1 (Patched)",
                .internal_name = "txp4",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/txp4/0112L_J2.BIN", "" }
            },
            { .files_no = 0 }
        }
    },
...
machine_at_txp4_init(const machine_t *model)
{
    ...
    pci_init(PCI_CONFIG_TYPE_1);
    pci_register_slot(0x00, PCI_CARD_NORTHBRIDGE, 0, 0, 0, 0);
    pci_register_slot(0x08, PCI_CARD_NORMAL,      1, 2, 3, 4); /* unused? */
    pci_register_slot(0x09, PCI_CARD_NORMAL,      4, 1, 2, 3);
    pci_register_slot(0x0A, PCI_CARD_NORMAL,      3, 4, 1, 2);
    pci_register_slot(0x0B, PCI_CARD_NORMAL,      2, 3, 4, 1);
    pci_register_slot(0x0C, PCI_CARD_NORMAL,      1, 2, 3, 4);
    pci_register_slot(0x0D, PCI_CARD_NORMAL,      1, 2, 3, 4); /* unused? */
...
static const device_config_t txp4x_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "txp4x",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            ...
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 0112el-1",
                .internal_name = "txp4x_aw0112b",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/txp4x/0112EL.001", "" }
            },
            {
                ...
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/txp4x/0112ELJ2.BIN", "" }
            },
            {
                .name          = "MR BIOS V3.46 - Revision V09BB5WB",
                .internal_name = "txp4x_mr346",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/txp4x/v09bb5wb.bin", "" }
            },
            { .files_no = 0 }
        }
    },
...
int
machine_at_txp4x_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
...
static const device_config_t ms5145_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "ms5145w",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                ...
                .internal_name = "ms5145a",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/ms5145/A545MS10.ROM", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1.0",
                .internal_name = "ms5145w10",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/ms5145/W545MS10.BIN", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 2.1",
                .internal_name = "ms5145w",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/ms5145/W545MS21.BIN", "" }
            },
            { .files_no = 0 }
        }
    },
...
const device_t ms5145_device = {
    .name          = "MSI MS-5145",
    .internal_name = "ms5145",
    .flags         = 0,
    .local         = 0,
    .init          = NULL,
    .close         = NULL,
    ...
    .speed_changed = NULL,
    .force_redraw  = NULL,
    .config        = ms5145_config
};

int
machine_at_ms5145_init(const machine_t *model)
{
    int ret;
    const char *fn;

    device_context(model->device);
    int is_amibios = !strcmp(device_get_config_bios("bios"), "ms5145a");
    fn             = device_get_bios_file(machine_get_device(machine), device_get_config_bios("bios"), 0);
    ret = bios_load_linear(fn, 0x000e0000, 131072, 0);
    device_context_restore();
...
static const device_config_t ms5158_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "ms5158w",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                .name          = "AMIBIOS 6 (071595) - Revision 1.1 (Japanese)",
                .internal_name = "ms5158aj",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/ms5158/A558J111.ROM", "" }
            },
            {
                .name          = "AMIBIOS 6 (071595) - Revision 1.2 (Traditional Chinese)",
                .internal_name = "ms5158atc",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/ms5158/A558C412.ROM", "" }
            },
            {
                .name          = "AMIBIOS 6 (071595) - Revision 1.3 (Simplified Chinese)",
                .internal_name = "ms5158asc",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/ms5158/A558C313.ROM", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1.4 (Premio 200F)",
                .internal_name = "ms5158w200f",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/ms5158/200F14.BIN", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1.4 (retail)",
                .internal_name = "ms5158w14",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/ms5158/W558MS14.BIN", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 2.1",
                .internal_name = "ms5158w",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/ms5158/W558MS21.BIN", "" }
            },
            { .files_no = 0 }
        }
    },
...
const device_t ms5158_device = {
    .name          = "MSI MS-5158",
    .internal_name = "ms5158",
    .flags         = 0,
    .local         = 0,
    .init          = NULL,
    .close         = NULL,
    ...
    .speed_changed = NULL,
    .force_redraw  = NULL,
    .config        = ms5158_config
};

int
machine_at_ms5158_init(const machine_t *model)
{
    int ret;
    const char *fn;

    device_context(model->device);
    int is_award = !strcmp(device_get_config_bios("bios"), "ms5158w") || !strcmp(device_get_config_bios("bios"), "ms5158w14") || !strcmp(device_get_config_bios("bios"), "ms5158w200f");
    fn           = device_get_bios_file(machine_get_device(machine), device_get_config_bios("bios"), 0);
    ret = bios_load_linear(fn, 0x000e0000, 131072, 0);
    device_context_restore();
...
static const device_config_t s56a_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        ...
        .bios           = {
            {
                .name          = "Award Modular BIOS v4.51PG - Revision B5",
                .internal_name = "56a5",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
            ...
            {
                .name          = "Award Modular BIOS v4.51PG - Revision B6b (beta)",
                .internal_name = "56a5_b6b",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
...
int
machine_at_s56a_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
...
/* VIA VP3 */
static const device_config_t ficpa2012_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "ficpa2012",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1.11JB14",
                .internal_name = "ficpa2012_jb14",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/ficpa2012/111jb14.awd", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1.13JB15",
                .internal_name = "ficpa2012_jb15",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/ficpa2012/113jb15.awd", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1.13JB154",
                .internal_name = "ficpa2012_jb154",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
            ...
            },
            {
                ...
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/ficpa2012/113jb16.awd", "" }
            },
            { .files_no = 0 }
        }
    },
...
const device_t ficpa2012_device = {
    .name          = "FIC PA-2012",
    .internal_name = "ficpa2012",
    .flags         = 0,
    .local         = 0,
...
int
machine_at_vib806ds_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/vib806ds/v30713sg.bin",
                           0x000e0000, 131072, 0);
...
static const device_config_t p5svb_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "p5svb",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                ...
                .internal_name = "p5svb_11",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/p5svb/SVB11.ROM", "" }
            },
            {
                ...
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/p5svb/SVB0106.BIN", "" }
            },
            { .files_no = 0 }
        }
    },
...
int
machine_at_p5svb_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
...
static const device_config_t ms5144_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "ms5144",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                ...
                .internal_name = "ms5144",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/ms5144/A544MS11.ROM", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1.2",
                .internal_name = "ms5144_451pg",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/ms5144/W544MS12.BIN", "" }
            },
            { .files_no = 0 }
        }
    },
...
const device_t ms5144_device = {
    ...
    .speed_changed = NULL,
    .force_redraw  = NULL,
    .config        = ms5144_config
};

int
machine_at_ms5144_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
...
static const device_config_t ms5146_config[] = {
    // clang-format off
    {
        ...
        .bios           = {
            ...
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 2.2 (Fujitsu-Siemens OEM)",
                .internal_name = "ms5146_fs",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/ms5146/W546F122.BIN", "" }
            },
            { .files_no = 0 }
        }
    },
...
static const device_config_t ms5147_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "ms5147",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 3.1",
                .internal_name = "ms5147",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/ms5147/W547MS31.BIN", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1.44b (LG IBM Multinet x55)",
                .internal_name = "ms5147_lgibm",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/ms5147/LGIBMX55.BIN", "" }
            },
            { .files_no = 0 }
        }
    },
...
const device_t ms5147_device = {
    ...
    .speed_changed = NULL,
    .force_redraw  = NULL,
    .config        = ms5147_config
};

int
machine_at_ms5147_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
...
int
machine_at_r547_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/r547/R547011.bin",
                           0x000e0000, 131072, 0);
    ...
    pci_register_slot(0x09, PCI_CARD_NORMAL,      1, 2, 3, 4);
    pci_register_slot(0x0B, PCI_CARD_NORMAL,      2, 3, 4, 1);
    pci_register_slot(0x14, PCI_CARD_VIDEO,       1, 2, 3, 4);    /* On-chip SiS graphics, absent here. */
...
int
machine_at_r548_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/r548/r548009.bin",
                           0x000e0000, 131072, 0);
    ...
    // clang-format off
    {
        ...
        .bios           = {
            ...
            },
            {
                ...
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/sp98agpx/0104XLJ2.BIN", "" }
            },
            { .files_no = 0 }
        }
    },
...
const device_t sp98agpx_device = {
    .name          = "ASUS SP98AGP-X",
    .internal_name = "sp98agpx",
    .flags         = 0,
    .local         = 0,
    ...
    .speed_changed = NULL,
    .force_redraw  = NULL,
    .config        = sp98agpx_config
};

int
machine_at_sp98agpx_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
...
int
machine_at_ga586sg_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/ga586sg/5sg.115",
                           0x000e0000, 131072, 0);
...
static const device_config_t ms5168_config[] = {
    // clang-format off
    {
        ...
        .bios           = {
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1.2",
                .internal_name = "ms5168",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/ms5168/W568MS12.BIN", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1.3B2",
                .internal_name = "ms5168_13b2",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/ms5168/W568MS13.002", "" }
            },
            { .files_no = 0 }
        }
    },
...
const device_t ms5168_device = {
    ...
    .speed_changed = NULL,
    .force_redraw  = NULL,
    .config        = ms5168_config
};

int
machine_at_ms5168_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
...
int
machine_at_r581a_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/r581a/r581008.bin",
                           0x000e0000, 131072, 0);
...
int
machine_at_5atxb_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/5atxb/5atxb.bin",
                           0x000e0000, 131072, 0);
...
static const device_config_t ms5163_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "ms5163",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1.4B4 (Beta)",
                .internal_name = "ms5163_beta",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/ms5163/W563MS14.004", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 4.1",
                .internal_name = "ms5163",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/ms5163/W563MS41.bin", "" }
            },
            { .files_no = 0 }
        }
    },
...
int
machine_at_ms5167_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/ms5167/W567MS41.BIN",
                           0x000e0000, 131072, 0);
