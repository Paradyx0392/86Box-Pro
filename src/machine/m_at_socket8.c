...
machine_at_686fx_init(const machine_t *model)
{
    ...
    ret = bios_load_linear("roms/machines/686fx/6fx.14",
                           0x000e0000, 131072, 0);
...
int
machine_at_sl60a_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/sl60a/60a-b3.bin",
                           0x000e0000, 131072, 0);
...
static const device_config_t zida6dxp_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        ...
        .bios           = {
            ...
            },
            {
                ...
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/6dxp/6DXP_11.BIN", "" }
            },
            { .files_no = 0 }
        }
    },
...
const device_t zida6dxp_device = {
    .name          = "Zida Tomato 6DXP",
    .internal_name = "6dxp",
    .flags         = 0,
    .local         = 0,
    .init          = NULL,
    ...
    .speed_changed = NULL,
    .force_redraw  = NULL,
    .config        = zida6dxp_config
};

int
machine_at_zida6dxp_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
    ...
    device_add_params(machine_get_kbc_device(machine), (void *) model->kbc_params);
    device_add_params(&um8669f_device, (void *) 0);
    device_add(&intel_flash_bxt_device); /* guess */
