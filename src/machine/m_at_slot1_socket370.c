...
static const device_config_t pb1408_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "pb1408",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                .name          = "AMIBIOS 6 (071595) - Revision 01/24/2000",
                .internal_name = "pb1408ami",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/pb1408/14a2cp08.rom", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 03/24/2000",
                .internal_name = "pb1408",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/pb1408/award5.bin", "" }
            },
            { .files_no = 0 }
        }
    },
...
const device_t pb1408_device = {
    ...
    .speed_changed = NULL,
    .force_redraw  = NULL,
    .config        = pb1408_config
};

int
machine_at_pb1408_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
    ...
    device_add((size > 131072) ? &sst_flash_39sf020_device /* assumed */ : &sst_flash_39sf010_device);
...
/* VIA Apollo Pro 133 */
static const device_config_t m6vca_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "m6vca",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 10/28/1999",
                .internal_name = "m6vca_10281999",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/m6vca/VCA1028B.bin", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 01/14/2000",
                .internal_name = "m6vca",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/m6vca/vca0114f.bin", "" }
            },
            { .files_no = 0 }
        }
    },
...
static const device_config_t p6bat_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "p6bat",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 5.6 06/22/2000",
                .internal_name = "p6bat",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/p6bat/bata+56.BIN", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 06/30/2000 (Matsonic MS-7112C)",
                .internal_name = "ms7112c",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/p6bat/06302k.BIN", "" }
            },
            { .files_no = 0 }
        }
    },
...
static const device_config_t p6batme_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "p6batme",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 5.5 06/22/2000",
                .internal_name = "p6batme",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/p6batme/batme55.bin", "" }
            },
            {
                .name          = "Award Modular BIOS v4.51PG - eSupport upgrade",
                .internal_name = "p6batme_esupport",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 262144,
                .files         = { "roms/machines/p6batme/2a6lge1w.bin", "" }
            },
            { .files_no = 0 }
        }
    },
...
const device_t p6batme_device = {
    ...
    .speed_changed = NULL,
    .force_redraw  = NULL,
    .config        = p6batme_config
};

int
machine_at_p6batme_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
