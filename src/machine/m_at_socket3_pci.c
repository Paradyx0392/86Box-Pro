...
static const device_config_t ms4134_config[] = {
    // clang-format off
    {
        ...
        .bios           = {
            {
                .name          = "AMIBIOS 080893 - Revision AL51",
            ...
            {
                .name          = "AMIBIOS 080893 - Revision AL57",
...
static const device_config_t abpb4_config[] = {
    // clang-format off
    {
        ...
        .bios           = {
            ...
            {
                .name          = "Award Modular BIOS v4.50G - Revision C5",
                .internal_name = "abpb4",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/abpb4/AB-PB4_C5.bin", "" }
            },
            {
...
static const device_config_t a486pa_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
...
const device_t a486pa_device = {
    ...
    .speed_changed = NULL,
    .force_redraw  = NULL,
    .config        = a486pa_config
};

int
machine_at_a486pa_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
...
/* i420ZX */
static const device_config_t asi486s_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
...
const device_t asi486s_device = {
    ...
    .speed_changed = NULL,
    .force_redraw  = NULL,
    .config        = asi486s_config
};

int
machine_at_asi486s_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
...
static const device_config_t ms4144_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "ms4144",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                .name          = "AMI WinBIOS (072594) - Revision A75W 1.4",
                .internal_name = "ms4144",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/ms4144/ms-4144-1.4.bin", "" }
            },
            {
                .name          = "Award Modular BIOS v4.50PG - Revision WF54S",
                .internal_name = "ms4144_v450pg",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/ms4144/WF54S.bin", "" }
            },
            { .files_no = 0 }
        }
    },
...
static const device_config_t zi4d_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        ...
        .bios           = {
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 1.72f",
                .internal_name = "4dps",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
            ...
            {
                .name          = "Award Modular BIOS v4.51PG - Revision 4.00a",
                .internal_name = "4dps_400a",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
...
const device_t zi4d_device = {
    .name          = "Zida Tomato 4DPS",
    .internal_name = "4dps",
    .flags         = 0,
    .local         = 0,
    .init          = NULL,
...
int
machine_at_zi4d_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
...
static const device_config_t b84xxuud_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "84xxuuda",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            ...
            },
            {
                ...
                .local         = 0,
                .size          = 131072,
                .files         = { "roms/machines/84xxuuda/uud0520s.bin", "" }
            },
            { .files_no = 0 }
        }
    },
...
const device_t b84xxuud_device = {
    .name          = "Biostar MB-84xxUUD-A",
    .internal_name = "84xxuuda",
    .flags         = 0,
    .local         = 0,
    .init          = NULL,
    ...
    .speed_changed = NULL,
    .force_redraw  = NULL,
    .config        = b84xxuud_config
};

int
machine_at_b84xxuud_init(const machine_t *model)
{
    int         ret = 0;
    const char *fn;
...
static const device_config_t g486vpa_config[] = {
    // clang-format off
    {
        ...
        .bios           = {
            {
                .name          = "Award Modular BIOS v4.50GP - Revision 03",
                .internal_name = "g486vpa_450gp",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
            ...
            {
                .name          = "Award Modular BIOS v4.50PG - Revision E5",
