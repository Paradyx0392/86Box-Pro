...
device_set_context(device_context_t *ctx, const device_t *dev, int inst)
{
    static const struct {
        ...
        { .old = "BCM SQ-578", .new = "BCM SQ578" },
        { .old = "BCM SQ-588", .new = "BCM SQ588" },
        ...
        { .old = "Rise Computer R418", .new = "Rise R418" },
        ...
        { .old = "ABIT AB-BX6", .new = "ABIT AB-BX6 (ver. 1.0)" },
        { .old = "ABIT AB-BX6 first edition", .new = "ABIT AB-BX6 (ver. 1.0)" },
        { .old = "ABIT AB-BX6 second edition", .new = "ABIT AB-BX6 (ver. 2.0)" },
        { .old = "MSI MS-6147", .new = "MSI MS-6147 (ver. 1.0)" },
        { .old = "MSI MS-6147 first edition", .new = "MSI MS-6147 (ver. 1.0)" },
        { .old = "MSI MS-6147 second edition", .new = "MSI MS-6147 (ver. 1.1)" },
